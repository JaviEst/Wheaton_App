 ...
 * parse the response.
 */
public final class events_fragment_utils {

    /** Tag for the log messages */
    public static final String LOG_TAG = events_fragment_utils.class.getSimpleName();
    ...
    /**
     * Create a private constructor because no one should ever create a {@link events_fragment_utils} object.
     * This class is only meant to hold static variables and methods, which can be accessed
     * directly from the class name QueryUtils (and an object instance of QueryUtils is not needed).
     */
    private events_fragment_utils() {
    }
    ...
    /**
     * Return a list of {@link events_fragment_class} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<events_fragment_class> extractFeatureFromJson(String earthquakeJSON) {
        // right now, the input string is ignored.

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<events_fragment_class> earthquakes = new ArrayList<>();
